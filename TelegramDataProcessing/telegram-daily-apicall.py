...
# This script queries the Telegram API for messages from the @YemenSul channel
    ...
    try:
        async def main(phone):
            ...
            if len(messages)<=0:
                ...
                preBucket='aws-glue-yeti-inputs'
                preKey='yeti-economics/pre/exch/raw_yemensul_channel_message'
